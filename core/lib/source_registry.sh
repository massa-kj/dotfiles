...
_source_registry_load_implicit() {
    _source_registry_register_source \
        ...
        "${DOTFILES_ROOT}/backends"

    _source_registry_register_source \
        "user" \
        "implicit" \
        "${DOTFILES_CONFIG_HOME}/features" \
        "${DOTFILES_CONFIG_HOME}/backends"
}
...
source_registry_load() {
    local sources_yaml="${1:-${DOTFILES_SOURCES_FILE:-}}"
    ...
    for source_id in "${source_ids[@]}"; do
        ...
        local feature_dir="${DOTFILES_DATA_HOME}/sources/${source_id}/features"
        local backend_dir="${DOTFILES_DATA_HOME}/sources/${source_id}/backends"
