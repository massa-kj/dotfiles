...
$env:DOTFILES_ROOT                  = "$TmpRoot\repo"
$global:DOTFILES_ROOT               = $env:DOTFILES_ROOT
$env:DOTFILES_PLATFORM              = "linux"
$global:DOTFILES_PLATFORM           = "linux"
$env:DOTFILES_CONFIG_HOME           = "$TmpRoot\config\dotfiles"
$global:DOTFILES_CONFIG_HOME        = $env:DOTFILES_CONFIG_HOME
$env:DOTFILES_DATA_HOME             = "$TmpRoot\data\dotfiles"
$global:DOTFILES_DATA_HOME          = $env:DOTFILES_DATA_HOME
$env:DOTFILES_SOURCES_FILE          = "$env:DOTFILES_CONFIG_HOME\sources.yaml"
$global:DOTFILES_SOURCES_FILE       = $env:DOTFILES_SOURCES_FILE
$global:SUPPORTED_FEATURE_SPEC_VERSION = "1"

$FeatureRoot = "$env:DOTFILES_ROOT\features"
$BackendRoot = "$env:DOTFILES_ROOT\backends"

foreach ($d in @(
    $FeatureRoot, $BackendRoot,
    "$env:DOTFILES_CONFIG_HOME\features", "$env:DOTFILES_CONFIG_HOME\backends",
    "$env:DOTFILES_DATA_HOME\sources"
...
$alphaEntry = $idx.features.PSObject.Properties["core/alpha"]?.Value
...
$betaEntry = $idx.features.PSObject.Properties["core/beta"]?.Value
...
$futureEntry = $idx.features.PSObject.Properties["core/future"]?.Value
...
$capEntry = $idx.features.PSObject.Properties["core/withcap"]?.Value
...
$gitEntry  = $idxReal.features.PSObject.Properties["core/git"]?.Value
$bashEntry = $idxReal.features.PSObject.Properties["core/bash"]?.Value
