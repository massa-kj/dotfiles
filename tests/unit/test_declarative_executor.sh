...
FS_TARGET="$TMPDIR_ROOT/home/.config/dotfiles/marker"
TEST_FEATURE_DIR="$TMPDIR_ROOT/feat_fs"

_make_feature_yaml "  - kind: fs
    id: fs:test-marker
    source: files/marker
    path: ${TMPDIR_ROOT}/home/.config/dotfiles/marker
    entry_type: file
    op: link"
...
FS_COPY_TARGET="$TMPDIR_ROOT/home/.config/dotfiles/copyfile"
...
_make_feature_yaml "  - kind: fs
    ...
    path: ${TMPDIR_ROOT}/home/.config/dotfiles/copyfile
    entry_type: file
    op: copy"
...
FS_FALLBACK_TARGET="$TMPDIR_ROOT/home/.config/dotfiles/marker2"
...
_make_feature_yaml "  - kind: fs
    id: fs:fallback
    path: ${TMPDIR_ROOT}/home/.config/dotfiles/marker2
    entry_type: file
    op: link"
