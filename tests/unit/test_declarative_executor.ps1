...
$fsTarget = Join-Path $TmpRoot "home" ".config" "dotfiles" "marker"
...
$copyTarget = Join-Path $TmpRoot "home" ".config" "dotfiles" "copyfile"
...
$fallbackTarget = Join-Path $TmpRoot "home" ".config" "dotfiles" "marker2"
