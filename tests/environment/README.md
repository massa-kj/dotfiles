...
Full-stack integration tests that run the dotfiles system in isolated environments.
...
Each test spins up a fresh container, runs bootstrap, executes `dotfiles apply`,
