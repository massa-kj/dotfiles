# Minimal setup for running dotfiles in a Windows environment
...
Write-Host "  2. Apply a profile: .\dotfiles.ps1 apply profiles\windows.yaml"
Write-Host ""
Write-Host "Notes:"
